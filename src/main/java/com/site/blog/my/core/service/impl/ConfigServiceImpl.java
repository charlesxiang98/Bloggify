...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteDescription = "personal blog is builted based on SpringBoot2+Thymeleaf+Mybatis";
    ...
    public static final String yourEmail = "davidxiang3517@gmail.com";
    public static final String yourName = "Daivd";

    public static final String footerAbout = "David's personal blog.";
    public static final String footerICP = "中国 xxxxxx-x号";
    public static final String footerCopyRight = "David";
